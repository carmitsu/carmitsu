...
export default function Privacy({navbar, language}: Lang) {
  ...
  return (
    <div className="rounded-lg m-4 bg-default-100 border-medium border-default-200 p-2 md:p-4">
      <h1 className="text-center my-6 text-4xl">Privacy Policy</h1>
      <div className="p-4 md:p-8">
        <p className="my-1">Last updated: April 06, 2024</p>
        <p className="my-1">This Privacy Policy describes Our policies and procedures on the collection, use and
          disclosure of Your
          information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
        <p className="my-1">We use Your Personal data to provide and improve the Service. By using the Service, You
          agree to the collection and use of information in accordance with this Privacy Policy.</p>
        <h2 className="text-2xl ml-1 my-6">Interpretation and Definitions</h2>
        <h3 className="text-xl my-2 ml-1">Interpretation</h3>
        <p className="my-1">The words of which the initial letter is capitalized have meanings defined under the
          following conditions.
          The
          following definitions shall have the same meaning regardless of whether they appear in singular or in
          plural.</p>
        <h3 className="text-xl my-2 ml-1">Definitions</h3>
        <p className="my-1">For the purposes of this Privacy Policy:</p>
        <ul className="list-disc pl-6 mt-2">
          <li>
            <p className="my-1"><strong>Account</strong> means a unique account created for You to access our Service or
              parts of our
              Service.</p>
          </li>
          <li>
            <p className="my-1"><strong>Affiliate</strong> means an entity that controls, is controlled by or is under
              common control
              with
          ...
          <li>
            <p className="my-1"><strong>Company</strong> (referred to as either &quot;the
              Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CarMitsu,
              Kowalska 12, 84-208 Dobrzewino, Polska.</p>
          </li>
          <li>
            <p className="my-1"><strong>Cookies</strong> are small files that are placed on Your computer, mobile device
              or any other
              device by a website, containing the details of Your browsing history on that website among its many uses.
            </p>
          </li>
          <li>
            <p className="my-1"><strong>Country</strong> refers to: Poland</p>
          </li>
          <li>
            <p className="my-1"><strong>Device</strong> means any device that can access the Service such as a computer,
              a cellphone or a
              digital tablet.</p>
          </li>
          <li>
            <p className="my-1"><strong>Personal Data</strong> is any information that relates to an identified or
              identifiable
              individual.
            </p>
          </li>
          <li>
            <p className="my-1"><strong>Service</strong> refers to the Website.</p>
          </li>
          <li>
            <p className="my-1"><strong>Service Provider</strong> means any natural or legal person who processes the
              data on behalf of
              the
          ...
          <li>
            <p className="my-1"><strong>Usage Data</strong> refers to data collected automatically, either generated by
              the use of the
              Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
          </li>
          <li>
            <p className="my-1"><strong>Website</strong> refers to {siteTLD?.split("/").pop()}, accessible from <a
              href={siteTLD}
              rel="external nofollow noopener"
              target="_blank">{siteTLD}</a>
            </p>
          </li>
          <li>
            <p className="my-1"><strong>You</strong> means the individual accessing or using the Service, or the
              company, or other legal
              entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
          </li>
        </ul>
        <h2 className="text-2xl ml-1 my-6">Collecting and Using Your Personal Data</h2>
        <h3 className="text-xl my-2 ml-1">Types of Data Collected</h3>
        <h4>Personal Data</h4>
        <p className="my-1">While using Our Service, We may ask You to provide Us with certain personally identifiable
          information that
          can
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>
            <p className="my-1">First name and last name</p>
          </li>
          <li>
            <p className="my-1">Phone number</p>
          </li>
          <li>
            <p className="my-1">Usage Data</p>
          </li>
        </ul>
        <h4>Usage Data</h4>
        <p className="my-1">Usage Data is collected automatically when using the Service.</p>
        <p className="my-1">Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP
          address), browser
        ...
        <p className="my-1">When You access the Service by or through a mobile device, We may collect certain
        ...
        <p className="my-1">We may also collect information that Your browser sends whenever You visit our Service or
          when You access the
          Service by or through a mobile device.</p>
        <h4>Tracking Technologies and Cookies</h4>
        <p className="my-1">We use Cookies and similar tracking technologies to track the activity on Our Service and
          store certain
        ...
        <p className="my-1">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies
          remain on Your
        ...
        <ul className="list-disc pl-6 mt-2">
          <li>
            <p className="my-1"><strong>Necessary / Essential Cookies</strong></p>
            <p className="my-1">Type: Session Cookies</p>
            <p className="my-1">Administered by: Us</p>
            <p className="my-1">Purpose: These Cookies are essential to provide You with services available through the
              Website and to
          ...
          <li>
            <p className="my-1"><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
            <p className="my-1">Type: Persistent Cookies</p>
            <p className="my-1">Administered by: Us</p>
            <p className="my-1">Purpose: These Cookies identify if users have accepted the use of cookies on the
              Website.</p>
          </li>
          <li>
            <p className="my-1"><strong>Functionality Cookies</strong></p>
            <p className="my-1">Type: Persistent Cookies</p>
            <p className="my-1">Administered by: Us</p>
            <p className="my-1">Purpose: These Cookies allow us to remember choices You make when You use the Website,
              such as
              remembering
        ...
        <p className="my-1">For more information about the cookies we use and your choices regarding cookies, please
          visit our Cookies
          Policy or the Cookies section of our Privacy Policy.</p>
        <h3 className="text-xl my-2 ml-1">Use of Your Personal Data</h3>
        <p className="my-1">The Company may use Personal Data for the following purposes:</p>
        <ul className="list-disc pl-6 mt-2">
          <li>
            <p className="my-1"><strong>To provide and maintain our Service</strong>, including to monitor the usage of
              our Service.</p>
          </li>
          <li>
            <p className="my-1"><strong>To manage Your Account:</strong> to manage Your registration as a user of the
              Service. The
              Personal
          ...
          <li>
            <p className="my-1"><strong>For the performance of a contract:</strong> the development, compliance and
              undertaking of the
              purchase contract for the products, items or services You have purchased or of any other contract with Us
              through the Service.</p>
          </li>
          <li>
            <p className="my-1"><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other
              equivalent forms
          ...
          <li>
            <p className="my-1"><strong>To provide You</strong> with news, special offers and general information about
              other goods,
          ...
          <li>
            <p className="my-1"><strong>To manage Your requests:</strong> To attend and manage Your requests to Us.</p>
          </li>
          <li>
            <p className="my-1"><strong>For business transfers:</strong> We may use Your information to evaluate or
              conduct a merger,
          ...
          <li>
            <p className="my-1"><strong>For other purposes</strong>: We may use Your information for other purposes,
              such as data
              analysis,
        ...
        <p className="my-1">We may share Your personal information in the following situations:</p>
        <ul className="list-disc pl-6 mt-2">
        ...
        <h3 className="text-xl my-2 ml-1">Retention of Your Personal Data</h3>
        <p className="my-1">The Company will retain Your Personal Data only for as long as is necessary for the purposes
          set out in this
          Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal
          obligations (for example, if we are required to retain your data to comply with applicable laws), resolve
          disputes, and enforce our legal agreements and policies.</p>
        <p className="my-1">The Company will also retain Usage Data for internal analysis purposes. Usage Data is
        ...
        <h3 className="text-xl my-2 ml-1">Transfer of Your Personal Data</h3>
        <p className="my-1">Your information, including Personal Data, is processed at the Company's operating offices
          and in any other
        ...
        <p className="my-1">Your consent to this Privacy Policy followed by Your submission of such information
          represents Your agreement
          to that transfer.</p>
        <p className="my-1">The Company will take all steps reasonably necessary to ensure that Your data is treated
          securely and in
          ...
          information.</p>
        <h3 className="text-xl my-2 ml-1">Delete Your Personal Data</h3>
        <p className="my-1">You have the right to delete or request that We assist in deleting the Personal Data that We
          have collected
          about You.</p>
        <p className="my-1">Our Service may give You the ability to delete certain information about You from within the
          Service.</p>
        <p className="my-1">You may update, amend, or delete Your information at any time by signing in to Your Account,
          if you have one,
        ...
        <p className="my-1">Please note, however, that We may need to retain certain information when we have a legal
          obligation or
          lawful
          basis to do so.</p>
        <h3 className="text-xl my-2 ml-1">Disclosure of Your Personal Data</h3>
        <h4>Business Transactions</h4>
        <p className="my-1">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
          transferred. We
          will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy
          Policy.</p>
        <h4>Law enforcement</h4>
        <p className="my-1">Under certain circumstances, the Company may be required to disclose Your Personal Data if
          required to do so
          by
          law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <h4>Other legal requirements</h4>
        <p className="my-1">The Company may disclose Your Personal Data in the good faith belief that such action is
          necessary to:</p>
        <ul className="list-disc pl-6 mt-2">
        ...
        <h3 className="text-xl my-2 ml-1">Security of Your Personal Data</h3>
        <p className="my-1">The security of Your Personal Data is important to Us, but remember that no method of
        ...
        <h2 className="text-2xl ml-1 my-6">Children's Privacy</h2>
        <p className="my-1">Our Service does not address anyone under the age of 13. We do not knowingly collect
        ...
        <p className="my-1">If We need to rely on consent as a legal basis for processing Your information and Your
          country requires
          consent from a parent, We may require Your parent's consent before We collect and use that information.</p>
        <h2 className="text-2xl ml-1 my-6">Links to Other Websites</h2>
        <p className="my-1">Our Service may contain links to other websites that are not operated by Us. If You click on
          a third party
        ...
        <p className="my-1">We have no control over and assume no responsibility for the content, privacy policies or
          practices of any
          third party sites or services.</p>
        <h2 className="text-2xl ml-1 my-6">Changes to this Privacy Policy</h2>
        <p className="my-1">We may update Our Privacy Policy from time to time. We will notify You of any changes by
          posting the new
          Privacy Policy on this page.</p>
        <p className="my-1">We will let You know via email and/or a prominent notice on Our Service, prior to the change
          becoming
          effective
          and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
        <p className="my-1">You are advised to review this Privacy Policy periodically for any changes. Changes to this
          Privacy Policy
          are
          effective when they are posted on this page.</p>
        <h2 className="text-2xl ml-1 my-6">Contact Us</h2>
        <p className="my-1">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul className="list-disc pl-6 mt-2">
          <li>By email: biuro@carmitsu.pl</li>
        </ul>
      </div>
    </div>
  );
